	...
	<div id="main_content">
		<div id="right">
			...
			<div class="duongdan">
				...
				<a href="<?php echo 'loai-san-pham/'.$title['slug']; ?>">
		...
		$this->load->view('frontend/'.$this->theme_name.'/header'); ?>
		...
		<div id="main_content">
			<div id="right">
				...
				<div class="duongdan">
					<a href="<?php base_url(); ?>"><span class="tencty">Trang chủ</span></a>
					<span class="duongdan1"> | </span>
					<a href="<?php //echo $category['category_slug']; ?>">
				...
				<div class="box_container">
					<div class="wap_item">        
						<h2>Hiện không có sản phẩm nào ?</h2>
